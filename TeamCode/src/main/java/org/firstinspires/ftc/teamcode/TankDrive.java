...
public final class TankDrive {
    public static class Params {
        ...
        public double inPerTick = 0.025836;
        public double trackWidthTicks = 0;

        // feedforward parameters (in tick units)
        public double kS = 2.2344642224610665;
        public double kV = 0.004384296400268731;
        public double kA = 0;
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "drive_left"));
        rightMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "drive_right"));
